			...
			<div class="main-sidemenu">
				<div class="app-sidebar__user clearfix">
					<div class="dropdown user-pro-body">
						<div class="">
							<img alt="user-img" class="avatar avatar-xl brround" src="{{URL::asset('https://icon-library.com/images/admin-icon/admin-icon-12.jpg')}}"><span class="avatar-status profile-status bg-green"></span>
						</div>
						<div class="user-info">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ route('admin.courses.create')}}">{{ __('main.add_course') }}</a></li>
							<li><a class="slide-item" href="{{ route('admin.courses.index')}}">{{ __('main.courses_all') }}</a></li>
						</ul>
					</li>
					{{-- <li class="slide">
