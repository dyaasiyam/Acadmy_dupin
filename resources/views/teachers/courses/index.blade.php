...
@endsection
@section('title', __('main.list_course'))
...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">{{ __('main.courses') }}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ __('main.list_course') }}</span>
						</div>
					</div>
        ...
        <table class="table text-md-nowrap" id="example1">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a class="btn btn-sm btn-info" href="{{ route('teacher.courses.show', $course->id) }}"><i class="fas fa-eye"></i></a>
